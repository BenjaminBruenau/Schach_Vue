<template>
  <div class="toast top-0 position-absolute p-3 end-0 mt-5" role="alert" id="toast" style="margin-right: 1em">
    <div class="toast-header">
      <svg v-if="color === 'BLACK'" xmlns="http://www.w3.org/2000/svg" version="1.1" class="svg-piece" viewBox="0 0 45 45" height="25" width="25">
      ...
      <svg v-if="color === 'WHITE'" xmlns="http://www.w3.org/2000/svg" version="1.1" class="svg-piece" viewBox="0 0 45 45" height="25" width="25">
        <g style="fill:none; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;">
...
export default {
  ...
  watch: {
    show() {
      //ToDo: NOT WORKING Some Issue with Watcher
      ...
      console.log("SHOW TOAST: ", this.show)
      if (this.show) {
        this.toast.show();
      }
    }
